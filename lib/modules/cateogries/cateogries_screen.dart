...
import 'package:donations_app/modules/cateogries/categoryProductsScreen.dart';
...
class CateogriesScreen extends StatelessWidget {
  ...
  Widget buildCatItem(DataModelCa modelCa, context) => InkWell(
        onTap: () {
          ...
          navigateTo(context, CategoryProductsScreen(modelCa.name));
        },
        child: Container(
          child: Padding(
            ...
            child: Row(
              children: [
                Image(
                  image: NetworkImage(modelCa.image),
                  width: 80.0,
                  height: 80.0,
                  fit: BoxFit.cover,
                ),
